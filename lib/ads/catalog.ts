...
const MOCK_PRODUCTS: Product[] = [
  {
    "id": "oss-1",
    "title": "PrismDB OSS",
    "tagline": "Lightweight embedded multi-model database for local-first software",
    "description": "Apache 2.0 licensed vector, document, and key-value store optimized for low-memory microservices.",
    "logo": "https://placehold.co/96x96/0f172a/8b5cf6?text=PD",
    "link": "https://example.com/prismdb",
    ...
    "maker": {
      "name": "Marcus Bell",
      "username": "mbell",
      "avatar": "https://placehold.co/64x64/1e293b/8b5cf6?text=M"
    }
  }
];
...
const MOCK_SITE: SiteConfig = {
  "key": "opensourceradar",
  "name": "OpenSourceRadar",
  "domain": "opensourceradar.com",
