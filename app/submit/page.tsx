...
export const metadata: Metadata = { title: 'Launch a Product — OpenSourceRadar' };
  ...
  return (
    <div className="container" style={{ maxWidth: '760px', paddingTop: '3rem', paddingBottom: '5rem' }}>
      <div style={{ marginBottom: '2.5rem' }}>
        ...
        <h1 style={{ fontSize: '2.5rem', marginTop: '0.5rem', marginBottom: '1rem' }}>Launch on OpenSourceRadar</h1>
      ...
      <div className="sidebar-card" style={{ padding: '2rem', marginBottom: '2rem' }}>
        ...
        <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
          ...
          <li style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
            <CheckCircle2 size={16} style={{ color: 'var(--color-primary)', flexShrink: 0 }} />
            <span style={{ color: 'var(--text-body)', fontSize: '14px' }}>Relevant to the open-source ecosystem.</span>
          </li>
        </ul>
      </div>
