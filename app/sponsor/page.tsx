...
export const metadata: Metadata = { title: 'Sponsor & Advertise — OpenSourceRadar' };
  ...
  return (
    <div className="container" style={{ maxWidth: '800px', paddingTop: '3rem', paddingBottom: '5rem' }}>
      <div style={{ marginBottom: '2.5rem' }}>
        ...
        <h1 style={{ fontSize: '2.5rem', marginTop: '0.5rem', marginBottom: '1rem' }}>Advertise on {config?.name || 'OpenSourceRadar'}</h1>
        <p style={{ fontSize: '1.15rem', color: 'var(--text-body)', lineHeight: 1.6 }}>
          Reach targeted buyers, engineers, and power users in the open-source niche.
        </p>
      </div>

      <div className="sidebar-card" style={{ padding: '2rem', marginBottom: '2rem' }}>
        <h2 style={{ fontSize: '1.25rem', marginBottom: '1.25rem' }}>Why Sponsor OpenSourceRadar?</h2>
        <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <li style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
            <CheckCircle size={18} style={{ color: 'var(--color-primary)', flexShrink: 0, marginTop: '3px' }} />
            <span style={{ color: 'var(--text-body)', fontSize: '14.5px' }}><strong>High Intent Readership:</strong> Visitors actively evaluating open-source tools.</span>
          </li>
          <li style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
            <CheckCircle size={18} style={{ color: 'var(--color-primary)', flexShrink: 0, marginTop: '3px' }} />
