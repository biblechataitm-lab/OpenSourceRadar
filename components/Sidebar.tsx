      ...
      <div className="sidebar-card">
        <div className="sidebar-card-title">
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
            <Compass size={14} style={{ color: 'var(--color-primary)' }} /> About {config?.name || 'OpenSourceRadar'}
          </span>
        </div>
        <p className="sidebar-card-body">
          {config?.name || 'OpenSourceRadar'} is a curated launch directory listing premier tools, software, and platforms in the open-source ecosystem.
        </p>
      </div>
